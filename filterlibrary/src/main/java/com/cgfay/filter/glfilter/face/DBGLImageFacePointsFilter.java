 ...
 */
public class DBGLImageFacePointsFilter extends GLImageFilter {
    ...
    public DBGLImageFacePointsFilter(Context context) {
        this(context, VertexShader, FragmentShader);
    }

    public DBGLImageFacePointsFilter(Context context, String vertexShader, String fragmentShader) {
            ...
            if (LandmarkEngine.getInstance().getFaceSize() > 0) {
                ...
                for (int i = 0; i < faceArrays.size(); i++) {
                    if (faceArrays.get(i).vertexPoints != null) {
                        ...
                        System.arraycopy(faceArrays.get(i).vertexPoints, 0, mPoints, 0, faceArrays.get(i).vertexPoints.length);
