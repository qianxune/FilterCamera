...
import com.scorpio.camera.Util.FileUtils;
...
public class GalleryActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        private void openAblum() {
            GalleryActivity.this.startActivityForResult(new Intent(
                            GalleryActivity.this, SelectPictureActivity.class),
        ...
        private void handleEditorImage(Intent data) {
            ...
            if (isImageEdit){
               // Toast.makeText(this, getString("path", newFilePath), Toast.LENGTH_LONG).show();
            }else{//未编辑  还是用原来的图片
